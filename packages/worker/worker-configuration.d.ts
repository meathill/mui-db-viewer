/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: efe197ce0ddd8d34fc7dd959d033676f)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    REPLICATE_API_KEY: '';
    REPLICATE_MODEL: '';
    HSM_CALL_MODE: string;
    HSM_URL: string;
    HSM_SECRET: string;
    HSM_SERVICE: Fetcher /* hsm */;
  }
}

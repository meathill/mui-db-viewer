/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: a06c8bdd630ecd8b756a7458a8eedf10)
...
declare namespace Cloudflare {
  interface Env {
    ...
    ASSETS: Fetcher;
    NEXTJS_ENV: string;
    WORKER_SELF_REFERENCE: Fetcher /* mui-db-viewer */;
    API_WORKER: Fetcher /* mui-db-worker */;
  }
}
